exports.run = (bot, message, args) => {
  ...
  if (message.author.id === "259758466942369794") return message.reply("*Administering dosage of chemotherapy to combat Habnal Cancer* :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive: :radioactive:");
